...
const Popup = () => {
  ...
  const options = useMemo(
    (): ModelOption[] => [
      ...
      { displayName: "BOW/ RNN", value: "tfidf-rnn" },
      ...
      { displayName: "Word2Vec/ Logistic Regression", value: "word2vec-nb" },
      { displayName: "Word2Vec/ Decision Tree", value: "word2vec-nb" },
      { displayName: "Word2Vec/ Random Forest", value: "word2vec-nb" },
      { displayName: "Word2Vec/ Support Vector Machine", value: "word2vec-nb" },
      { displayName: "Word2Vec/ RNN", value: "word2vec-nb" },
      { displayName: "FastText/ Naive Bayes", value: "fasttext-nb" },
      { displayName: "FastText/ Logistic Regression", value: "fasttext-nb" },
      { displayName: "FastText/ Decision Tree", value: "fasttext-nb" },
      { displayName: "FastText/ Random Forest", value: "fasttext-nb" },
      { displayName: "FastText/ Support Vector Machine", value: "fasttext-nb" },
      { displayName: "FastText/ RNN", value: "fasttext-nb" },
      { displayName: "Transformer/ BERT", value: "bert" },
      { displayName: "Transformer/ XLNet", value: "xlnet" },
    ],
    []
  );
